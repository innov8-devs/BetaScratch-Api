...
import { AdminUpdateOneWithoutOtpNestedInput } from '../admin/admin-update-one-without-otp-nested.input';

@InputType()
export class OtpUpdateWithoutUserInput {
    ...
    @Field(() => AdminUpdateOneWithoutOtpNestedInput, {nullable:true})
