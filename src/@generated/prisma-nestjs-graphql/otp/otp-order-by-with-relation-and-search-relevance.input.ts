...
import { OtpOrderByRelevanceInput } from './otp-order-by-relevance.input';

@InputType()
export class OtpOrderByWithRelationAndSearchRelevanceInput {
    ...
    @Field(() => OtpOrderByRelevanceInput, {nullable:true})
