...
import { UserUpdateOneRequiredWithoutTokensInput } from '../user/user-update-one-required-without-tokens.input';
...
export class TokenUpdateInput {
    ...
    @Field(() => UserUpdateOneRequiredWithoutTokensInput, {nullable:true})
