...
@InputType()
export class PurchaseUncheckedUpdateWithoutCouponInput {
    ...
    @Field(() => CartUncheckedUpdateManyWithoutPurchaseNestedInput, {nullable:true})
    cards?: CartUncheckedUpdateManyWithoutPurchaseNestedInput;
