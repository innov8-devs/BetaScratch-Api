...
import { FlutterwaveLogOrderByRelevanceInput } from './flutterwave-log-order-by-relevance.input';

@InputType()
export class FlutterwaveLogOrderByWithRelationAndSearchRelevanceInput {
    ...
    @Field(() => FlutterwaveLogOrderByRelevanceInput, {nullable:true})
    _relevance?: FlutterwaveLogOrderByRelevanceInput;
}
