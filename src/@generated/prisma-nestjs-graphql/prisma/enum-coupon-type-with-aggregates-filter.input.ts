...
import { NestedEnumCOUPON_TYPEWithAggregatesFilter } from './nested-enum-coupon-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumCOUPON_TYPEFilter } from './nested-enum-coupon-type-filter.input';

@InputType()
export class EnumCOUPON_TYPEWithAggregatesFilter {
