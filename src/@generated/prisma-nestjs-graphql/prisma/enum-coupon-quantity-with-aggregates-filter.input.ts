...
import { NestedEnumCOUPON_QUANTITYWithAggregatesFilter } from './nested-enum-coupon-quantity-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumCOUPON_QUANTITYFilter } from './nested-enum-coupon-quantity-filter.input';

@InputType()
export class EnumCOUPON_QUANTITYWithAggregatesFilter {
