...
import { NestedEnumRAFFLE_TYPEWithAggregatesFilter } from './nested-enum-raffle-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumRAFFLE_TYPEFilter } from './nested-enum-raffle-type-filter.input';

@InputType()
export class EnumRAFFLE_TYPEWithAggregatesFilter {
