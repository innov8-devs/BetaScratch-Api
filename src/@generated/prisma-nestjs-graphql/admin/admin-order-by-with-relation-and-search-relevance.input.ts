...
import { AdminOrderByRelevanceInput } from './admin-order-by-relevance.input';

@InputType()
export class AdminOrderByWithRelationAndSearchRelevanceInput {
    ...
    @Field(() => AdminOrderByRelevanceInput, {nullable:true})
